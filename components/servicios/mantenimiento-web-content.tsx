  ...
  "@graph": [
    {
      ...
      "description": "Planes de mantenimiento web profesional en España. Copias de seguridad, actualizaciones de plugins, optimización de velocidad y soporte técnico inmediato.",
      "provider": {
        "@type": "LocalBusiness",
